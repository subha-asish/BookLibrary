...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Plan Your Day", "Choose your Goal, plan your day.", R.drawable.travel_page_one));
        mList.add(new ScreenItem("Add the Books", "Select the book, Start Reading. give your\n best ", R.drawable.travel_page_two));
        mList.add(new ScreenItem("Just Do it", "Enjoy ", R.drawable.travel_page_three));
